...
@interface YNWebViewProgress : NSObject <UIWebViewDelegate>
{
    ...
    _Bool _interactive;
    float _progress;
    id <YNWebViewProgressDelegate> _progressDelegate;
...
@property(nonatomic) __weak id <YNWebViewProgressDelegate> progressDelegate; // @synthesize progressDelegate=_progressDelegate;
- (void)reset;
