...
@interface YNMyAccountViewController : YNBaseViewController <UITableViewDataSource, UITableViewDelegate>
{
    YNTableView *_tableView;
}

- (void).cxx_destruct;
- (void)enterPhoneChangePage;
...
- (void)varificationCurrentPassword:(id)arg1;
- (void)viewDidLoad;
