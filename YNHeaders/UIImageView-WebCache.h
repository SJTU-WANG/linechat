...
- (void)sd_setChatMessgeCellBigImageWithURL:(id)arg1 placeholderImage:(id)arg2 imageSize:(struct CGSize)arg3 options:(unsigned long long)arg4 progress:(CDUnknownBlockType)arg5 completed:(CDUnknownBlockType)arg6;
- (void)sd_setChatMessgeCellBigImageWithURL:(id)arg1 placeholderImage:(id)arg2 options:(unsigned long long)arg3 imageSize:(struct CGSize)arg4 completed:(CDUnknownBlockType)arg5;
