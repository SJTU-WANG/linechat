...
@class UIImage, YNRichTextMsg;

@interface YNChatRichTextMessage : YNChatMessage
{
    UIImage *_image;
...
- (void)deleteLocalThumbnailImageData;
...
- (_Bool)isBigCharacterImage;
@property(retain, nonatomic) YNRichTextMsg *msg; // @synthesize msg=_msg;
- (id)notificationBody;
- (id)originImageExportPath;
- (id)originImageLocalPath;
- (void)prepareForForwardMedia;
- (void)prepareForUploadMedia:(CDUnknownBlockType)arg1;
- (id)reportInfo;
- (_Bool)resourceExists;
- (id)richTextMsg;
- (void)setAssetsUrl:(id)arg1;
