...
@interface WKAuthWebViewProgress : NSObject <UIWebViewDelegate>
{
    ...
    _Bool _interactive;
    float _progress;
    id <WKAuthWebViewProgressDelegate> _progressDelegate;
...
@property(nonatomic) __weak id <WKAuthWebViewProgressDelegate> progressDelegate; // @synthesize progressDelegate=_progressDelegate;
- (void)reset;
