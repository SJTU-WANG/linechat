...
@class CADisplayLink, NSArray, NSDate, NSProgress, NSString, NSTimer, SDPMBBackgroundView, UIButton, UIColor, UIFont, UILabel;

@interface SDPMBProgressHUD : UIView
{
    ...
    float _progress;
    id <SDPMBProgressHUDDelegate> _delegate;
    ...
    SDPMBBackgroundView *_bezelView;
    SDPMBBackgroundView *_backgroundView;
    UIView *_customView;
    UILabel *_label;
...
@property(readonly, nonatomic) SDPMBBackgroundView *backgroundView; // @synthesize backgroundView=_backgroundView;
@property(retain, nonatomic) NSArray *bezelConstraints; // @synthesize bezelConstraints=_bezelConstraints;
@property(readonly, nonatomic) SDPMBBackgroundView *bezelView; // @synthesize bezelView=_bezelView;
...
- (void)dealloc;
@property(nonatomic) __weak id <SDPMBProgressHUDDelegate> delegate; // @synthesize delegate=_delegate;
